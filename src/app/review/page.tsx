...
export default function MonthReviewPage() {
  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 bg-[#0c0f0e] flex items-center justify-center">
        <div className="text-[#5A9A74] animate-pulse text-xl">Loading your review...</div>
      </div>
    );
  }
    ...
    return (
      <div className="fixed inset-0 bg-[#0c0f0e] flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          <Sparkles className="w-16 h-16 text-[#5A9A74] mx-auto mb-6" />
  ...
  return (
    <div className="fixed inset-0 bg-[#0c0f0e] overflow-hidden" style={{ fontFamily: 'var(--font-dm-sans, sans-serif)' }}>
      {/* Watermark */}
      <div className="fixed top-5 left-6 text-[#3D6B5266] text-lg z-50 tracking-wide" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
        thallo
      </div>
      ...
      >
        ...
        <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="0" style={{
          background: 'radial-gradient(ellipse at 30% 20%, rgba(61,107,82,0.15) 0%, transparent 60%), radial-gradient(ellipse at 70% 80%, rgba(61,107,82,0.08) 0%, transparent 50%), #0c0f0e'
        }}>
          <div className="max-w-md mx-auto w-full">
            <div className="animate opacity-0 text-[#5A9A74] text-[13px] uppercase tracking-[3px] font-medium mb-3">{month}</div>
            ...
            <div className="animate opacity-0 text-[72px] leading-none text-[#5A9A74] mb-2 tracking-tight" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
              ${headline.totalSpent.toLocaleString()}
            </div>
            <div className="animate opacity-0 text-[15px] text-[#8a9490] mb-8">total spent this month</div>
            
            <div className="animate opacity-0 flex justify-between items-center py-4 border-t border-[#3D6B5226]">
          ...
          {showPaywall ? (
            <div className="max-w-md mx-auto w-full relative">
              ...
              <div className="filter blur-md opacity-30 select-none pointer-events-none">
                <div className="text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Your Wins</div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="bg-[#ffffff08] border border-[#3D6B5226] rounded-2xl p-5 text-center">
            ...
            <div className="max-w-md mx-auto w-full">
              <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Your Wins</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="animate opacity-0 bg-[#ffffff08] border border-[#3D6B5226] rounded-2xl p-5 text-center">
                  <div className="text-2xl mb-2">🎯</div>
        ...
        {!isFreeUser && (
          <>
            ...
            <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="2" style={{
              ...
              <div className="max-w-md mx-auto w-full">
                <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Heads Up</div>
                <h2 className="animate opacity-0  text-[32px] leading-tight mb-8 text-[#e8e6e1]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
                ...
                {surprises.overshoots.map((o: { category: string; budgeted: number; actual: number; pctOver: number }, i: number) => (
                  <div key={i} className="animate opacity-0 mb-6">
                    ...
                    <div className="h-2 rounded-full bg-[#ffffff10] relative overflow-hidden">
                      <div
                        className="h-full bg-[#3D6B52] rounded-full absolute left-0 top-0"
            ...
            <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="3" style={{
              background: 'radial-gradient(ellipse at 40% 60%, rgba(61,107,82,0.1) 0%, transparent 60%), #0c0f0e'
            }}>
              <div className="max-w-md mx-auto w-full">
                <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Spending Trends</div>
                <h2 className="animate opacity-0  text-[32px] leading-tight mb-8 text-[#e8e6e1]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
                  How your categories<br/>moved over <span className="text-[#5A9A74]">3 months</span>
                </h2>
            ...
            <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="4" style={{
              background: 'radial-gradient(ellipse at 50% 50%, rgba(61,107,82,0.1) 0%, transparent 50%), #0c0f0e'
            }}>
              <div className="max-w-md mx-auto w-full">
                <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Money Flow</div>
                <h2 className="animate opacity-0  text-[32px] leading-tight mb-8 text-[#e8e6e1]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
                  Where your <span className="text-[#5A9A74]">${flow.income.toLocaleString()}</span><br/>actually went
                </h2>

                <div className="animate opacity-0 text-center mb-6">
                  <div className=" text-4xl text-[#5A9A74] mb-1" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>${flow.income.toLocaleString()}</div>
                ...
                <div className="animate opacity-0 flex justify-center mb-4">
                  <svg width="200" height="40" viewBox="0 0 200 40">
                    ...
                    <path d="M100,0 L100,40" stroke="rgba(61,107,82,0.3)" strokeWidth="1.5" fill="none"/>
                ...
                <div className="animate opacity-0 flex gap-2">
                  ...
                  <div className="flex-1 bg-[#3D6B5220] border border-[#3D6B5233] rounded-2xl p-5 text-center relative">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-4 bg-[#ffffff1a]" />
                    <div className="text-3xl font-bold text-[#5A9A74] mb-1">{flow.wants.pct}%</div>
            ...
            <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="5" style={{
              background: 'radial-gradient(ellipse at 50% 30%, rgba(61,107,82,0.12) 0%, transparent 60%), #0c0f0e'
            }}>
              <div className="max-w-md mx-auto w-full text-center">
                <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">Financial Health</div>
                <h2 className="animate opacity-0  text-[32px] leading-tight mb-8 text-[#e8e6e1]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
                ...
                <div className="animate opacity-0 w-44 h-44 mx-auto mb-6 relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className=" text-5xl text-[#5A9A74]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>{score.current}</div>
            ...
            <div className="min-h-screen p-6 flex flex-col justify-center relative overflow-hidden card" data-card="6" style={{
              background: 'radial-gradient(ellipse at 30% 70%, rgba(61,107,82,0.12) 0%, transparent 60%), #0c0f0e'
            }}>
              <div className="max-w-md mx-auto w-full">
                <div className="animate opacity-0 text-[11px] uppercase tracking-[3px] text-[#3D6B52] font-semibold mb-4">
                ...
                <h2 className="animate opacity-0  text-[32px] leading-tight mb-8 text-[#e8e6e1]" style={{ fontFamily: 'var(--font-dm-serif-display, serif)' }}>
                  One move to make<br/><span className="text-[#5A9A74]">next month</span>
                </h2>

                {nudge ? (
                  <>
                    <div className="animate opacity-0 bg-[#3D6B5214] border border-[#3D6B5233] rounded-2xl p-7 mb-4">
                      <div className="text-3xl mb-4">{nudge.primary.emoji}</div>
                      <div className="text-base leading-relaxed text-[#e8e6e1] mb-4">
                        {nudge.primary.text}
                      </div>
                      <div className="text-[13px] text-[#5A9A74] font-medium">
                      ...
                      <div className="space-y-2">
                        {nudge.secondary.map((s: string, i: number) => (
                          <div key={i} className="flex items-center gap-2 text-[13px] text-[#8a9490]">
                            <div className="w-1 h-1 rounded-full bg-[#3D6B52] flex-shrink-0" />
                            <span>{s}</span>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="animate opacity-0 flex gap-3 mt-7">
                      ...
                      <Link
                        href="/dashboard"
                        className="flex-1 px-6 py-3 bg-gradient-to-r from-[#3D6B52] to-[#2D5440] text-white rounded-xl text-[14px] font-semibold text-center hover:opacity-90 transition"
                      >
                        Dashboard →
                      </Link>
                    </div>
