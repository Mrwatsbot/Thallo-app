    ...
    <div className="relative w-full h-full overflow-hidden">
      ...
      {currentSlide > 0 && (
        <button
          ...
          className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full glass-card items-center justify-center text-muted-foreground hover:text-foreground hover:border-[#3D6B524d] transition-all hover:scale-105"
          aria-label="Previous"
        >
      ...
      {currentSlide < totalSlides - 1 && (
        <button
          onClick={() => goTo(currentSlide + 1)}
          className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full glass-card items-center justify-center text-muted-foreground hover:text-foreground hover:border-[#3D6B524d] transition-all hover:scale-105"
          aria-label="Next"
        >
